...
public class BenhAnRequest {
    ...
    public BenhAnRequest(String maBA, String maBN, String maPK, String thoiGianKham, String lyDoKham) {
        this.maBA = maBA;
        this.maBN = maBN;
        this.maPK = maPK;
        this.thoiGianKham = thoiGianKham;
    ...
    public BenhAnRequest(BenhAnResponse response) {
        this.id = response.getId();
        this.maBA = response.getMaBA();
        this.thoiGianKham = response.getThoiGianKham();
        this.canNang = response.getCanNang();
        this.nhomMau = response.getNhomMau();
        this.nhietDo = response.getNhietDo();
        this.mach = response.getMach();
        this.huyetAp = response.getHuyetAp();
        this.nhipTho = response.getNhipTho();
        this.lyDoKham = response.getLyDoKham();
        this.tinhTrangHT = response.getTinhTrangHT();
        this.benhSu = response.getBenhSu();
        this.chanDoanSoBo = response.getChanDoanSoBo();
        this.yeuCauThem = response.getYeuCauThem();
        this.chanDoanSauCung = response.getChanDoanSauCung();
        this.huongDieuTri = response.getHuongDieuTri();
    }
